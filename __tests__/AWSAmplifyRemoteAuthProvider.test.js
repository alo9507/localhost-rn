...
import AWSAmplifyRemoteAuthProvider from "../src/service/authentication/RemoteAuthProvider/AWSAmplifyRemoteAuthProvider"
...
test("successfully signs up new user", async () => {
    ...
    try {
        const authResult = await awsAuthProvider.signUp(`new_user${uuidv4()}@g.com`, "abc123!!")
